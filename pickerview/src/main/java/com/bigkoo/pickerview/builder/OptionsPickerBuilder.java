...
public class OptionsPickerBuilder {
    ...
    //Option
    public OptionsPickerBuilder setClearText(String textContentClear) {
        mPickerOptions.textContentclear = textContentClear;
        return this;
    }

    public OptionsPickerBuilder setBottomText(String textContentbottom) {
    ...
    public OptionsPickerBuilder setClearColor(int textColorClear) {
    ...
    public OptionsPickerBuilder setClearSelectDataListener(OnClearSelectDataListener listener) {
        mPickerOptions.onClearSelectDataListener = listener;
        return this;
    }
    public OptionsPickerBuilder setPickerViewGravity(int gravity) {
