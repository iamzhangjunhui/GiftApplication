...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setClearText(String textContentclear) {
        mPickerOptions.textContentclear = textContentclear;
        return this;
    }
    ...
    public TimePickerBuilder setBottomText(String textContentBottom) {
        mPickerOptions.textContentBottom = textContentBottom;
        return this;
    }
    ...
    public TimePickerBuilder setClearColor(int textColorClear) {
        mPickerOptions.textColorClear = textColorClear;
        return this;
    }
    ...
    public TimePickerBuilder setSubCalSize(int textSizeSubmitCancel) {
        mPickerOptions.textSizeClear = textSizeSubmitCancel;
        return this;
    }
    ...
    public TimePickerBuilder setClearSelectDataListener(OnClearSelectDataListener listener) {
        mPickerOptions.onClearSelectDataListener = listener;
        return this;
    }
    public TimePickerBuilder setPickerViewGravity(int gravity) {
    ...
    public void setClickSureButtonDismiss(boolean clickSureButtonDismiss) {
        mPickerOptions.clickSureButtonShow = clickSureButtonDismiss;
    }
}
