...
public class BasePickerView {
    ...
    protected void initViews(int gravity) {
    ...
    public void createDialog(int gravity) {
        if (dialogView != null) {
            ...
            if (dialogWindow != null) {
                ...
                dialogWindow.setGravity(gravity);//可以改成Bottom
                dialogWindow.addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
                //对话框显示在底部，设置宽度与屏幕宽度一致
                if (dialogWindow.getAttributes().gravity == Gravity.BOTTOM) {
