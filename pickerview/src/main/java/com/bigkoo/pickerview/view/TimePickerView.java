...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private static final String TAG_BOTTOM_SHOW = "bottom_show";//点击之后，不取消显示
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            btnBottom = (TextView) findViewById(R.id.btnBottom);

            btnClear.setTag(TAG_CLEAR);
            btnCancel.setTag(TAG_CANCEL);
            btnBottom.setTag(mPickerOptions.clickSureButtonShow ? TAG_BOTTOM_SHOW : TAG_BOTTOM);
            ...
            tvTitle.setText(TextUtils.isEmpty(mPickerOptions.textContentTitle) ? context.getResources().getString(R.string.view_time_picker_title) : mPickerOptions.textContentTitle);//默认为空
    ...
    public TimePickerView setBtnCancelVisible(int b) {
        btnCancel.setVisibility(b);
        return this;
    }

    public TimePickerView setBtnClearVisible(int b) {
        btnClear.setVisibility(b);
        return this;
    }
    public TimePickerView setOnTimeSelectListener(OnTimeSelectListener listener) {
